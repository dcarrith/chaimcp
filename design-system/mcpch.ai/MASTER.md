...
| Secondary | `#4ADE80` | `--color-secondary` |
| CTA/Accent | `#F59E0B` | `--color-cta` |
| Background | `#1C1917` | `--color-background` |
| Text | `#F3F4F6` | `--color-text` |

**Color Notes:** Dark Roast background (Stone-900), Golden Primary, Neon Chia Green Secondary.
